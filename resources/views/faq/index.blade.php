...
@section('content')
    ...
    <div style="float: left; text-align: left; color: white; width: 500px; padding-top: 15px; padding-left: 15px; padding-right: 15px; padding-bottom: 15px; margin-top: 600px;" class="intro neon blue"  data-aos="fade-up-right">
